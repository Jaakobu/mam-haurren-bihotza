...
//Ajout d'un modérateur ou admin et envoi de mail
...
function add_modo($name,$email,$role,$token){
    ...
    $message = '
        <html lang="fr-FR" style="font-family: sans-serif;">
            <head>
                <meta charset="UTF-8">
            </head>
            <body>
                Voici votre identifiant et code unique à insérer sur <a href="http://mam.test:8080/blog/admin/index.php?page=new">cette page</a>:
    ...
    $header .= 'From: no-reply@site.fr' . "\r\n" . 'Reply-To: contact@site.fr' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
